...
//    private var listener: OnFragmentInteractionListener? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loginButton = getView()!!.findViewById(R.id.button_login)
        registerButton = getView()!!.findViewById(R.id.button_register)
        ...
        registerButton.setOnClickListener {
            NavHostFragment.findNavController(this).navigate(R.id.action_splash_to_register)
        }
    }
